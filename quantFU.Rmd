...
Since at this point I do not want to share Gallium data publicly I simulate one trial using `rpact` @rpact with very similar properties as the Gallium data.
